    ...
    setPosition: function(step) {
      ...
      if (!arrowOffset) {
        ...
        if (arrowOffset === 'center') {
          arrowEl.style.left = bubbleWidth/2 + bubblePadding - arrowEl.offsetWidth/2 + '%';
        }
        else {
          // Numeric pixel value
          arrowEl.style.left = arrowOffset + '%';
        }
      }
        ...
        if (arrowOffset === 'center') {
          ...
          arrowEl.style.top = bubbleHeight/2 + bubblePadding - arrowEl.offsetHeight/2 + '%';
        }
        else {
          // Numeric pixel value
          arrowEl.style.top = arrowOffset + '%';
        }
      }
